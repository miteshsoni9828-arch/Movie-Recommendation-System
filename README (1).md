...
|--------|---------|--------|
| IMDB Movies Dataset | ~45,000 | [Kaggle - IMDB](https://www.kaggle.com/) |
| TMDB Movies Dataset | ~5,000 | [Kaggle - TMDB](https://www.kaggle.com/) |
| **Merged Dataset** | **~50,000** | Combined & Cleaned |

### 🔗 Dataset Merging Strategy
- Both datasets were merged on **movie title** and **release year** as common keys.
- Duplicate entries were removed after merging.
- Missing values were handled using imputation and dropping strategies.
- Final cleaned dataset was used for feature engineering and model training.
