...
🛠️ Tech Stack
Tool / LibraryPurposePython 3.8+Core programming languagePandasData loading, merging, and cleaningNumPyNumerical operationsScikit-LearnTF-IDF Vectorizer, Cosine SimilarityMatplotlib / SeabornData visualization and EDANLTKText preprocessing (stemming, stopwords)Jupyter NotebookDevelopment environment
...
System finds the movie in the dataset
TF-IDF vectorizer converts the movie's combined features (genres + cast + keywords + overview) into a vector
Cosine Similarity is calculated between the input movie and all other movies
